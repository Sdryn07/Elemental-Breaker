...
void gameOver(){
	char str3[20];
	sprintf_s(str3, "Score: %f", total);
	if (counter >= (brickNo-10)){
		iSetColor(120, 0, 120);
		iText(670, 650, "FEVER MODE PRESS 1, 2, 3 TO SWITCH ELEMENTS", GLUT_BITMAP_HELVETICA_18);
	}
	if (counter == brickNo){
		
		iText(600, 350, "LEVEL COMPLETE", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(650, 300, str3, GLUT_BITMAP_HELVETICA_18);
	}
}
#endif